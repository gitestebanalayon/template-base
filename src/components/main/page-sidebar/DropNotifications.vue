...
<template>
    <div class="nav-item dropdown d-none d-md-flex">
        <a href="#" class="nav-link position-relative" data-bs-toggle="dropdown" tabindex="-1" aria-label="Show notifications" aria-expanded="false">
            ...
            <span class="badge bg-red position-absolute mt-1 top-0 end-0"></span>
        </a>
